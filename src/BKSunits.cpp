...
QString BKSUnits::description(int unit)
{
    switch(unit)
    {
    case NAV: return QString("BKSs");
//    case mNAV: return QString("Milli-BKSs (1 / 1" THIN_SP_UTF8 "000)");
//    case uNAV: return QString("Micro-BKSs (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
