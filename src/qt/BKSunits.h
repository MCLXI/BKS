...
#ifndef BKS_QT_BKSUNITS_H
#define BKS_QT_BKSUNITS_H
...
/** BKS unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class BKSUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit BKSUnits(QObject *parent);

    /** BKS units.
      @note Source: https://en.BKS.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BKS,
...
typedef BKSUnits::Unit BKSUnit;

#endif // BKS_QT_BKSUNITS_H
