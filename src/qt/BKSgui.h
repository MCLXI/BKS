...
#ifndef BKS_QT_BKSGUI_H
#define BKS_QT_BKSGUI_H
...
/**
  BKS GUI main class. This class represents the main window of the BKS UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class BKSGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit BKSGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~BKSGUI();
